...
<div id="page" class="site">
    <a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'bro-barbershop' ); ?></a>
            ...
            <div class="site-branding">
                ...
                <div class="site-title-wrapper">
                    ...
                    if ( $barbershop_description || is_customize_preview() ) :
                        ?>
                        <p class="site-description"><?php echo $barbershop_description; // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?></p>
                    <?php endif; ?>
                </div>
            </div><!-- .site-branding -->
